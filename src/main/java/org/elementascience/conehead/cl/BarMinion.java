        ...
        if (downloadRes == 0) {
          ...
          if (opResult.result == 0) {
            ...
            if (resultCode == 0) {
              ...
              // TODO copy the archive contents up to s3 storage
              ...
              if (errorString.length() == 0) {
                ...
                // TODO notify barman that it should accept the new article as it sits in s3
